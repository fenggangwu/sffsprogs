...
#ifdef SMR
	{ "razstartblkno", FLDT_DRFSBNO, OI(OFF(razstartblkno)), C1, 0, TYP_NONE },
	{ "razblkcnt", FLDT_DRFSBNO, OI(OFF(razblkcnt)), C1, 0, TYP_NONE },
	{ "estartblkno", FLDT_DRFSBNO, OI(OFF(estartblkno)), C1, 0, TYP_NONE },
	{ "eblkcnt", FLDT_DRFSBNO, OI(OFF(eblkcnt)), C1, 0, TYP_NONE },
	{ "istartblkno", FLDT_DRFSBNO, OI(OFF(istartblkno)), C1, 0, TYP_NONE },
	{ "iblkcnt", FLDT_DRFSBNO, OI(OFF(iblkcnt)), C1, 0, TYP_NONE },
	{ "bandsize", FLDT_UINT32D, OI(OFF(bandsize)), C1, 0, TYP_NONE },
	{ "superbandsize", FLDT_UINT32D, OI(OFF(superbandsize)), C1, 0, TYP_NONE },
	{ "ehead", FLDT_DRFSBNO, OI(OFF(ehead)), C1, 0, TYP_NONE },
	{ "etail", FLDT_DRFSBNO, OI(OFF(etail)), C1, 0, TYP_NONE },
#endif
	{ NULL }
};
